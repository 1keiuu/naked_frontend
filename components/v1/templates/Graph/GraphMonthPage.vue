...
import GraphMonth from '@/components/v1/templates/Graph/Contents/GraphMonth.vue'

export default defineComponent({
  props: {},
  components: { NkdDoughnutGraph, GraphMonth },
  setup(props, context) {
